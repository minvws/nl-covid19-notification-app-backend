...
describe("Manifest endpoints tests #multiple_exposure_keys #scenario #regression", function () {
    ...
    before(function () {
        return manifest().then(function (manifest) {
            ...
            for(i = 0; i< exposureKeySet.length; i++){
                ...
                let TemporaryExposureKey = result.keys
    ...
    it("Exposure Key sets has all needed property keys", function () {
            ...
            expect(exposure_keyset_decoded.signatureInfos[0]).to.have.nested.property("verificationKeyId");
            expect(exposure_keyset_decoded.signatureInfos[0]).to.have.nested.property("signatureAlgorithm");
