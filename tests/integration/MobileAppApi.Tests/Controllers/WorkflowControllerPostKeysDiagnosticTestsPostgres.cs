...
{
    [Trait("db", "postgres")]
    public class WorkflowControllerPostKeysDiagnosticTestsPostgres : WorkflowControllerPostKeysDiagnosticTests, IDisposable
    {
        private const string Prefix = nameof(WorkflowControllerPostKeysDiagnosticTests) + "_";
        private static DbConnection connection;

        public WorkflowControllerPostKeysDiagnosticTestsPostgres() : base(
