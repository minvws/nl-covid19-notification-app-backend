...
{
    public class ManifestV5Builder
    {
        private readonly ContentDbContext _contentDbContext;
        private readonly IEksConfig _eksConfig;
        private readonly IUtcDateTimeProvider _dateTimeProvider;

        public ManifestV5Builder(ContentDbContext contentDbContext, IEksConfig eksConfig, IUtcDateTimeProvider dateTimeProvider)
        {
        ...
        public async Task<ManifestContent> ExecuteAsync()
        {
            ...
            {
                ExposureKeySets = await _contentDbContext.SafeGetActiveContentIdListAsync(ContentTypes.ExposureKeySetV3, from, snapshot),
