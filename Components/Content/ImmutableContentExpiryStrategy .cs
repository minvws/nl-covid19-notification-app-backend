...
{
    public class ImmutableContentExpiryStrategy : IContentExpiryStrategy
    {
        private readonly IHttpResponseHeaderConfig _HttpResponseHeaderConfig;

        public ImmutableContentExpiryStrategy(IHttpResponseHeaderConfig httpResponseHeaderConfig)
        {
        ...
        {
            return _HttpResponseHeaderConfig.EksMaxTtl;
        }
    }
}