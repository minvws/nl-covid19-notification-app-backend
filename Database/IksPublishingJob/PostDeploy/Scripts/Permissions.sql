...
GRANT INSERT ON [dbo].[IksCreateJobInput] TO [Dbr_Service_EfgsUploader];
GRANT SELECT ON [dbo].[IksCreateJobInput] TO [Dbr_Service_EfgsUploader];
GRANT UPDATE ON [dbo].[IksCreateJobInput] TO [Dbr_Service_EfgsUploader];
GRANT DELETE ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
GRANT ALTER ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];

GRANT INSERT ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
GRANT SELECT ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
GRANT UPDATE ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
GRANT DELETE ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
GRANT ALTER ON [dbo].[IksCreateJobOutput] TO [Dbr_Service_EfgsUploader];
